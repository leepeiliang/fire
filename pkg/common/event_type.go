...
// DeviceData device data structure.
type DeviceGroupCustomizedData struct {
	DeviceGroupCustomizedMessage
	Devices []DeviceCustomizedData `json:"devices"`
}

// DeviceData device data structure.
type DeviceCustomizedData struct {
	DeviceCustomizedMessage
	Data map[string]*DataValue `json:"data"`
}

// CustomizedMessage the base structure of customized message.
type DeviceCustomizedMessage struct {
	DeviceID  string `json:"device_id"`
	Timestamp int64  `json:"timestamp"`
}

// CustomizedMessage the base structure of customized message.
type DeviceGroupCustomizedMessage struct {
